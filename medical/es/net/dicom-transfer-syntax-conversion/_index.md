...
weight: 16000
description: Transcodifique archivos DICOM entre sintaxis de transferencia en C# .NET. Soporte para JPEG, JPEG 2000, HTJ2K, JPEG XL, JPEG‑LS, RLE y formatos sin comprimir con la API Aspose.Medical.
---

{{< blocks/products/pf/main-wrap-class >}}

{{< blocks/products/pf/upper-banner h1="Conversión de Sintaxis de Transferencia DICOM en .NET C#" h2="Transcodifique archivos DICOM entre sintaxis de transferencia sin comprimir, JPEG, JPEG 2000, HTJ2K, JPEG XL, JPEG‑LS y RLE. Biblioteca .NET pura sin dependencias nativas." logoImageSrc="/medical/images/aspose_medical-brand.svg" pfName="Aspose.Medical" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/medical/net" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Medical" subTitlepfName="for .NET" >}}

{{< blocks/products/pf/feature-page-section h2="¿Qué es la sintaxis de transferencia?">}}

<p>Una <strong>Transfer Syntax</strong> define cómo se codifican los datos DICOM para almacenamiento y transmisión. Especifica tres aspectos clave: el orden de bytes (endianness), si las Representaciones de Valor son explícitas o implícitas, y el algoritmo de compresión aplicado a los datos de píxeles. Cada archivo DICOM declara su sintaxis de transferencia en el encabezado de Información Meta del Archivo.</p>

<p>Diferentes dispositivos médicos, servidores PACS y aplicaciones de visualización admiten distintos conjuntos de sintaxis de transferencia. <strong>Aspose.Medical for .NET</strong> proporciona el método <code>Transcode</code> para convertir entre sintaxis de transferencia, permitiendo interoperabilidad, optimización del almacenamiento y compatibilidad con herramientas de procesamiento — todo en una biblioteca .NET pura sin dependencias nativas.</p>

{{< /blocks/products/pf/feature-page-section >}}

{{< blocks/products/pf/feature-page-section h2="Transcodifique un archivo DICOM en C#">}}

<p>El método <code>DicomFile.Transcode</code> convierte un archivo DICOM de su sintaxis de transferencia actual a cualquier sintaxis de destino compatible. El método devuelve una nueva instancia de <code>DicomFile</code> — el original permanece sin cambios:</p>

<div class="codeblock" id="code">
 <h3>Transcodificación básica de DICOM - C#</h3>
...
<p>La tabla siguiente enumera todas las sintaxis de transferencia de datos de imagen DICOM estándar y su estado actual de soporte en Aspose.Medical for .NET. Todos los códecs compatibles están implementados en C# puro y son completamente independientes de la plataforma.</p>
...
<tr><td>Explicit VR Big Endian</td><td><code>1.2.840.10008.1.2.2</code></td><td>Sin comprimir (retirada)</td><td>Compatible</td></tr>
<tr><td>Encapsulated Uncompressed Explicit VR Little Endian</td><td><code>1.2.840.10008.1.2.1.98</code></td><td>Sin comprimir</td><td>No compatible</td></tr>
...
<tr><td>JPEG 2000 Lossless Only</td><td><code>1.2.840.10008.1.2.4.90</code></td><td>Sin pérdida</td><td>Compatible (lectura 8 bits color y 16 bits monocromo; escritura 16 bits monocromo o 8 bits RGB)</td></tr>
<tr><td>JPEG 2000</td><td><code>1.2.840.10008.1.2.4.91</code></td><td>Con pérdida o sin pérdida</td><td>Compatible (lectura 8 bits color y 16 bits monocromo; escritura 16 bits monocromo o 8 bits RGB)</td></tr>
<tr><td>JPEG 2000 Part 2 Multi-component Lossless Only</td><td><code>1.2.840.10008.1.2.4.92</code></td><td>Sin pérdida</td><td>No compatible</td></tr>
<tr><td>JPEG 2000 Part 2 Multi-component</td><td><code>1.2.840.10008.1.2.4.93</code></td><td>Con pérdida o sin pérdida</td><td>No compatible</td></tr>
...
<tr><td colspan="4"><strong>JPEG 2000 de alto rendimiento (HTJ2K)</strong></td></tr>
<tr><td>HTJ2K Lossless Only</td><td><code>1.2.840.10008.1.2.4.201</code></td><td>Sin pérdida</td><td>Compatible</td></tr>
<tr><td>HTJ2K with RPCL Options Lossless Only</td><td><code>1.2.840.10008.1.2.4.202</code></td><td>Sin pérdida</td><td>Compatible</td></tr>
<tr><td>HTJ2K</td><td><code>1.2.840.10008.1.2.4.203</code></td><td>Con pérdida o sin pérdida</td><td>Compatible</td></tr>
<tr><td colspan="4"><strong>JPEG XL</strong></td></tr>
<tr><td>JPEG XL Lossless</td><td><code>1.2.840.10008.1.2.4.110</code></td><td>Sin pérdida</td><td>Compatible</td></tr>
<tr><td>JPEG XL JPEG Recompression</td><td><code>1.2.840.10008.1.2.4.111</code></td><td>Sin pérdida</td><td>Solo decodificación (la codificación requiere un flujo fuente JPEG, no datos de píxeles)</td></tr>
<tr><td>JPEG XL</td><td><code>1.2.840.10008.1.2.4.112</code></td><td>Con pérdida o sin pérdida</td><td>Compatible (modo con pérdida)</td></tr>
</tbody>
</table>
...
<div class="codeblock" id="code">
 <h3>Descomprimir para procesar - C#</h3>
...
<div class="codeblock" id="code">
 <h3>Utilizar los códecs más recientes: HTJ2K y JPEG XL - C#</h3>
...
<p>La clase <code>TransferSyntax</code> expone propiedades que describen las características de codificación. Utilice estas propiedades para inspeccionar la sintaxis de transferencia actual de un archivo o para seleccionar una sintaxis de destino adecuada:</p>
...
<tr><td><code>IsDeflate</code></td><td><code>bool</code></td><td>Indica si la sintaxis utiliza compresión deflate</td></tr>
<tr><td><code>IsRetired</code></td><td><code>bool</code></td><td>Indica si la sintaxis de transferencia está retirada según el estándar DICOM</td></tr>
<tr><td><code>LossyCompressionMethod</code></td><td><code>LossyCompressionMethods</code></td><td>El identificador del método de compresión con pérdida según el estándar ISO</td></tr>
</tbody>
</table>
...
<tbody>
<tr><td>Calidad de imagen</td><td>Exacto a nivel de píxel &mdash; datos originales totalmente preservados</td><td>Algunos datos se pierden de forma permanente para lograr un tamaño menor</td></tr>
<tr><td>Relación de compresión</td><td>Typicalmente 2:1 a 3:1</td><td>Typicalmente 10:1 a 30:1 o más</td></tr>
<tr><td>Segura en ida y vuelta</td><td>Sí &mdash; descomprimir y obtener píxeles idénticos</td><td>No &mdash; cada re-codificación con pérdida degrada aún más la calidad</td></tr>
<tr><td>Casos de uso</td><td>Archivo, diagnóstico, registros legales</td><td>Revisión preliminar, telemedicina, transmisión en red</td></tr>
<tr><td>Códecs compatibles</td><td>JPEG Lossless, JPEG-LS, JPEG 2000 Lossless, HTJ2K Lossless, JPEG XL Lossless, RLE</td><td>JPEG Baseline, JPEG-LS Near-Lossless, JPEG 2000, HTJ2K, JPEG XL</td></tr>
</tbody>
</table>
...
{{< blocks/products/pf/slr-element name="Referencias de la API" href="https://reference.aspose.com/medical/net/" >}}
