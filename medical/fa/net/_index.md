...
<ul>
    ...
    <li>کد گذاری مجدد بین سینتکس های انتقال از جمله فشرده سازی JPEG، JPEG 2000، HTJ2K، JPEG-LS و RLE.</li>
    ...
    <li>پشتیبانی از HTJ2K (JPEG 2000 با توان بالا) برای فشرده سازی تصویربرداری پزشکی نسل بعدی.</li>
</ul>
</p>
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     پشتیبانی از فشرده سازی JPEG، JPEG 2000، HTJ2K، JPEG-LS و RLE
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Medical for .NET به طور کامل در کد مدیریت شده C# بدون هیچ وابستگی بومی نوشته شده است. برخلاف سایر کتابخانه های تصویربرداری پزشکی که به کدک های بومی یا ابزارهای خارجی متکی هستند، Aspose.Medical کاملاً خودکفا است. تمام کدک های فشرده سازی تصویر (JPEG، JPEG 2000، HTJ2K، JPEG-LS، RLE) در .NET خالص پیاده سازی شده اند و استقرار یکپارچه را در Windows، Linux و macOS بدون هیچ پیکربندی خاص پلتفرمی تضمین می کنند. این آن را برای استقرارهای کانتینری، محیط های ابری و سناریوهایی که نصب کتابخانه های بومی امکان پذیر نیست ایده آل می کند.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
