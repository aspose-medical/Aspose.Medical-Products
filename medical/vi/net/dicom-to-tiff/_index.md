---
title: .NET API để chuyển đổi DICOM sang TIFF - Aspose.Medical
weight: 12000

description: Thông tin về Aspose.Medical for .NET API để chuyển đổi DICOM sang TIFF
---

{{< blocks/products/pf/main-wrap-class >}}

{{< blocks/products/pf/upper-banner h1="API Aspose.Medical for .NET để chuyển DICOM sang TIFF" h2="Chuyển đổi DICOM sang TIFF để chia sẻ hình ảnh dễ dàng hơn" logoImageSrc="/medical/images/aspose_medical-brand.svg" pfName="Aspose.Medical" subTitlepfName="for .NET" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Medical" subTitlepfName="for .NET" >}}

{{< blocks/products/pf/feature-page-section h2="Các tính năng của DICOM to TIFF">}}

<p>Dễ dàng chuyển đổi các tệp DICOM định dạng TIFF. Aspose.Medical for .NET DICOM to TIFF trao quyền cho bạn:</p>
