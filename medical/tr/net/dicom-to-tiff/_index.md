---
title: DICOM'u TIFF'e dönüştürmek için API .NET - Aspose.Medical
weight: 12000

description: DICOM'u TIFF'ye dönüştürmek için Aspose.Medical for .NET API hakkında bilgi
---

{{< blocks/products/pf/main-wrap-class >}}

{{< blocks/products/pf/upper-banner h1="DICOM'u TIFF'e dönüştürmek için Aspose.Medical for .NET API" h2="Daha kolay görüntü paylaşımı için DICOM'u TIFF'e dönüştürün" logoImageSrc="/medical/images/aspose_medical-brand.svg" pfName="Aspose.Medical" subTitlepfName="for .NET" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Medical" subTitlepfName="for .NET" >}}

{{< blocks/products/pf/feature-page-section h2="DICOM'dan TIFF'e Özellikler">}}

<p>DICOM dosyalarını zahmetsizce TIFF formatına dönüştürün. Aspose.Medical for .NET DICOM'dan TIFF'e şunları yapmanızı sağlar:</p>
