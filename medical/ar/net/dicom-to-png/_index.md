---
title: .NET API لتحويل DICOM إلى PNG - Aspose.Medical
weight: 11000

description: معلومات حول Aspose.Medical for .NET API لتحويل DICOM إلى PNG
---

{{< blocks/products/pf/main-wrap-class >}}

{{< blocks/products/pf/upper-banner h1="Aspose.Medical for .NET API لطممع DICOM إلى PNG" h2="قم بتحويل DICOM إلى PNG لتسهيل مشاركة الصور" logoImageSrc="/medical/images/aspose_medical-brand.svg" pfName="Aspose.Medical" subTitlepfName="for .NET" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Medical" subTitlepfName="for .NET" >}}

{{< blocks/products/pf/feature-page-section h2="DICOM إلى ميزات PNG">}}

<p>قم بتحويل ملفات DICOM بتنسيق PNG دون عناء. Aspose.Medical for .NET DICOM إلى PNG يمكنك من:</p>
