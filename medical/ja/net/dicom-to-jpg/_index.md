---
title: .NET DICOM を JPG に変換する API - Aspose.Medical
weight: 7000

description: DICOM Aspose.Medical for .NET JPGに変換するAPIに関する情報
---

{{< blocks/products/pf/main-wrap-class >}}

{{< blocks/products/pf/upper-banner h1="DICOM を JPG に変換する API Aspose.Medical for .NET" h2="DICOMをJPGに変換して画像共有を容易にする" logoImageSrc="/medical/images/aspose_medical-brand.svg" pfName="Aspose.Medical" subTitlepfName="for .NET" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Medical" subTitlepfName="for .NET" >}}

{{< blocks/products/pf/feature-page-section h2="DICOMからJPGへの機能">}}

<p>DICOMファイルのJPG形式を簡単に変換します。DICOM から JPG へのAspose.Medical for .NETを使用すると、次のことが可能になります。</p>
