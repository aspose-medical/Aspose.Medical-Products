---
title: API .NET để chuyển đổi DICOM sang JPG - Aspose.Medical
weight: 7000

description: Thông tin về API Aspose.Medical for .NET để chuyển đổi DICOM sang JPG
---

{{< blocks/products/pf/main-wrap-class >}}

{{< blocks/products/pf/upper-banner h1="API Aspose.Medical for .NET để chuyển DICOM sang JPG" h2="Chuyển đổi DICOM sang JPG để chia sẻ hình ảnh dễ dàng hơn" logoImageSrc="/medical/images/aspose_medical-brand.svg" pfName="Aspose.Medical" subTitlepfName="for .NET" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Medical" subTitlepfName="for .NET" >}}

{{< blocks/products/pf/feature-page-section h2="Các tính năng của DICOM to JPG">}}

<p>Dễ dàng chuyển đổi các tệp DICOM định dạng JPG. Aspose.Medical for .NET DICOM to JPG trao quyền cho bạn:</p>
