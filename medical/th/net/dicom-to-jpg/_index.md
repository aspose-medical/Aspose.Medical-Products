---
title: .NET API เพื่อแปลง DICOM เป็น JPG - Aspose.Medical
weight: 7000

description: ข้อมูลเกี่ยวกับ Aspose.Medical for .NET API เพื่อแปลง DICOM เป็น JPG
---

{{< blocks/products/pf/main-wrap-class >}}

{{< blocks/products/pf/upper-banner h1="Aspose.Medical for .NET API เพื่อ convet DICOM เป็น JPG" h2="แปลง DICOM เป็น JPG เพื่อการแชร์ภาพที่ง่ายขึ้น" logoImageSrc="/medical/images/aspose_medical-brand.svg" pfName="Aspose.Medical" subTitlepfName="for .NET" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Medical" subTitlepfName="for .NET" >}}

{{< blocks/products/pf/feature-page-section h2="DICOM ถึง JPG คุณสมบัติ">}}

<p>แปลงไฟล์ DICOM รูปแบบ JPG ได้อย่างง่ายดาย Aspose.Medical for .NET DICOM เป็น JPG ช่วยให้คุณ:</p>
