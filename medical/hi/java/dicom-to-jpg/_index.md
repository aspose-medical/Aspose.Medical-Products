---
title: Java API DICOM को JPG में बदलने के लिए - Aspose.Medical
weight: 7000

description: DICOM को JPG में बदलने के लिए Java API के Aspose.Medical के बारे में जानकारी
---

{{< blocks/products/pf/main-wrap-class >}}

{{< blocks/products/pf/upper-banner h1="DICOM को JPG में convet करने के लिए Java API के लिए Aspose.Medical" h2="आसान छवि साझाकरण के लिए DICOM को JPG में बदलें" logoImageSrc="/medical/images/aspose_medical-brand.svg" pfName="Aspose.Medical" subTitlepfName="for Java" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Medical" subTitlepfName="for Java" >}}

{{< blocks/products/pf/feature-page-section h2="DICOM से JPG सुविधाएँ">}}

<p>आसानी से DICOM फ़ाइलों को JPG प्रारूप में कनवर्ट करें। Java DICOM से JPG के लिए Aspose.Medical आपको निम्न के लिए सशक्त बनाता है:</p>
